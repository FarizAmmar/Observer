...
<main class="mt-4 mb-5 px-4">
    ...
    {{-- Input Employee --}}
    <form class="mb-5" action="/employee/{{ $user->username }}" method="POST">
        @method('put')
        @csrf
        <div>
            <div class="row">
                ...
                <div class="form-group col-md-6 mb-2">
                    ...
                    <select class="form-control @error('position_id') is-invalid @enderror" name="position_id"
                        id="inputJabatan">
                        <option value="{{ $user->position->id }}" selected hidden>{{
                            $user->position->name }}
                        </option>
                ...
                <div class="form-group col-md-12 mb-2">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" name="address"
                        ...
                        placeholder="Masukan alamat lengkap">{{ old('address', $user->address) }}</textarea>
                    @error('address')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group col-md-6 mb-2">
                    ...
                    <select class="form-control @error('salary_id') is-invalid @enderror" name="salary_id"
                        id="inputSalary">
                        <option value="{{  $user->salary->id }}" selected hidden>Rp. {{
                            $user->salary->ammount }}
                        </option>
                ...
                <div class="form-group col-md-6 mb-2">
                    ...
                    <select class="form-control  @error('level_id') is-invalid @enderror" name="level_id"
                        id="inputRole">
                        <option value="{{ $user->level->id }}" selected hidden>{{
                            $user->level->name }}</option>
